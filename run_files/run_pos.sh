...
# Now
# G for gloss, B for gram_lex, P for PoS tag,
# M for source morpheme, #W for aligned lemma (word),
# I for morpheme position in word, and L for morpheme length.
...
ARGS+=" --pattern 22:Gx/Ix:0t0,0s1" #0s2"
...
ARGS+=" --pattern 42:Bx/Ix:0t1,0s1" #0s2"
ARGS+=" --pattern 43:Bx/Lx:0t1,0s2" #0s3"
# Experimental bigram
...
suffix='200_match' #'0_gold_match_1600' #'gold_match_1600_dict' #'1000_match' #'0_argmax_200' # Changer ici
#ARGS+=" --train-spc ../lost_experiment/train_tsez_pos.spc"
#ARGS+=" --train-ref ../lost_experiment/train_tsez_pos.ref"
ARGS+=" --train-spc ../results_2023_TALN/data/train_tsez_${suffix}_pos.spc"
ARGS+=" --train-ref ../results_2023_TALN/data/train_tsez_${suffix}_pos.ref"
...
ARGS+=" --test-spc  ../results_2023_TALN/data/test_tsez_${suffix}_pos.spc"
#ARGS+=" --test-out  tsez_exp/output_tsez_pos.out"
ARGS+=" --test-out  ../results_2023_TALN/output/output_tsez_${suffix}_pos.out"
...
ARGS+=" --mdl-save tsez_exp/model_tsez_${suffix}_pos.wgh"
ARGS+=" --str-save tsez_exp/model_tsez_${suffix}_pos.str"
ARGS+=" --mdl-compact"
