...
# F for morpheme position in word, L for morpheme length,
# D for initial letters, and E for final characters of the morpheme.
...
lang='lezgi' #'natugu' #'gitksan' #'lezgi' #'tsez'
suffix='conc_match_morph_601' # 591 #'0_gold_match_1600' # Changer ici
