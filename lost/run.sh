...
ARGS+=" --train-spc dat/train.spc"
ARGS+=" --train-ref dat/train.ref"

#ARGS+=" --devel-spc dat/devel.spc"
#ARGS+=" --devel-out devel-%02d.txt"

ARGS+=" --test-spc  dat/test.spc"
ARGS+=" --test-out  output.out"
ARGS+=" --test-fst  output.fst"
...
ARGS+=" --mdl-save model.wgh"
ARGS+=" --str-save model.str"
ARGS+=" --mdl-compact"
